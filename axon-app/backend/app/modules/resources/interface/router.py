...
from app.modules.resources.application.schemas import (
    ...
    InternalToolResponse, SyncResultResponse, SyncRemoteToolRequest,
...
@router.post("/internal-tools/sync-remote", response_model=SyncResultResponse)
async def sync_remote_tool(
