...
async def system_entity_upserted_workflow(ctx: inngest.Context, step: inngest.Step):
...
async def system_entity_deleted_workflow(ctx: inngest.Context, step: inngest.Step):
    entity_id = ctx.event.data.get("entity_id")
    entity_type = ctx.event.data.get("entity_type")
