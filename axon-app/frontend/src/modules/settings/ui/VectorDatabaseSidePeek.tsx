            ...
            footer={
                <div className="flex w-full justify-between items-center">
                    <Button 
                        ...
                        onClick={() => !('isMock' in db) && onDelete?.(db.id)}
        ...
        >
            <div className="space-y-12">
                ...
                <SidePeekGrid>
                    <SidePeekGridItem 
                        label="Host" 
                        value={<p className="text-white font-mono">{db.vector_database_connection_url || "aws-eu-central-1"}</p>} 
                    />
                    <SidePeekGridItem 
                        label="Typ" 
                        value={<p className="text-white">{db.vector_database_type.replace(/_/g, " ")}</p>} 
                    />
                </SidePeekGrid>
