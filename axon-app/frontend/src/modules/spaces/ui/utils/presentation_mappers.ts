...
export const MAP_OF_VISUAL_ZONE_COLORS_TO_CSS_CLASSES: Record<string, VisualStyleForZoneColor> = {
    purple: { 
        ...
        backgroundClassName: 'bg-purple-500/1',
    ...
    blue: { 
        ...
        backgroundClassName: 'bg-blue-500/1',
    ...
    pink: { 
        ...
        backgroundClassName: 'bg-pink-500/1',
    ...
    green: { 
        ...
        backgroundClassName: 'bg-green-500/1',
    ...
    yellow: { 
        ...
        backgroundClassName: 'bg-yellow-500/1',
    ...
    orange: { 
        ...
        backgroundClassName: 'bg-orange-500/1',
