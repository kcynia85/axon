...
# Add project root to path to allow 'backend.app' imports
...
from backend.app.modules.system.infrastructure.tables import *
from backend.app.modules.workspaces.infrastructure.tables import *
