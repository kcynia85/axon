...
import type { PropertyTableInputProps } from "@/shared/types/form/PropertyTableInput.types";
import { usePropertyTableInput } from "@/shared/hooks/form/usePropertyTableInput";

export const PropertyTableInput = (props: PropertyTableInputProps) => {
	const {
		inputValue,
		setInputValue,
		handleAdd,
