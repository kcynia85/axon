...
import type { DynamicListInputProps } from "@/shared/types/form/DynamicListInput.types";
import { useDynamicListInput } from "@/shared/hooks/form/useDynamicListInput";

export const DynamicListInput = (props: DynamicListInputProps) => {
	const {
		inputValue,
		setInputValue,
		handleAdd,
		handleRemove,
		handleChange,
	} = useDynamicListInput(props);

	const { items, onBlur, placeholder = "Item...", addPlaceholder = "Add new item..." } = props;
