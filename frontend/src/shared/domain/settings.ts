...
export const ModelTierSchema = z.enum(["Tier1", "Tier2"]);
export const ChunkingMethodSchema = z.enum(["Recursive_Character", "Code_Splitter", "Token_Splitter"]);

export const LLMProviderSchema = z.object({
    id: z.string().uuid(),
    provider_name: z.string(),
    provider_api_key_required: z.boolean(),
    provider_api_endpoint: z.string().url(),
...
export const LLMRouterSchema = z.object({
    ...
    router_strategy: z.enum(["Cost_Optimized", "Speed_Optimized", "Quality_Optimized"]),
...
export const VectorDatabaseSchema = z.object({
    ...
    vector_database_type: z.enum(["Postgres_pgvector", "ChromaDB", "Pinecone"]),
    ...
    vector_database_connection_status: z.enum(["Connected", "Disconnected"]),
