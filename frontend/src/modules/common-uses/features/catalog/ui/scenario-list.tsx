...
export const ScenarioList = ({ items }: ScenarioListProps) => {
    ...
    const handleUseTemplate = async (scenario: Scenario) => {
        try {
            ...
            if (categoryLower.includes("research")) domain = "discovery";
            if (categoryLower.includes("engineering") || categoryLower.includes("code")) domain = "delivery";
            if (categoryLower.includes("design")) domain = "design";
            if (categoryLower.includes("marketing") || categoryLower.includes("growth")) domain = "growth";
            if (categoryLower.includes("content") || categoryLower.includes("writing")) domain = "writing";
