...
import { useExternalServices } from "../application/use-external-services";
                ...
                <Card key={service.id} className="group hover:border-primary/50 transition-all flex flex-col">
                    <CardHeader className="pb-3 bg-muted/20">
                        <div className="flex justify-between items-start">
                            ...
                            <Badge variant={service.service_status === "Active" ? "default" : "secondary"} className="text-[8px] h-4">
                                {service.service_status || "Registered"}
                            </Badge>
                        </div>
