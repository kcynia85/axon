    ...
    <div className={cn("flex flex-col h-full bg-card text-card-foreground border-l shadow-lg w-96", className)}>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="border-b">
          <SectionHeader title="Node Details" icon={Settings} section="details" expandedSections={expandedSections} toggleSection={toggleSection} />
        ...
        <div className="border-b">
          <SectionHeader title="Execution Status" icon={Terminal} section="execution" expandedSections={expandedSections} toggleSection={toggleSection} />
