...
export function TemplateNode({ data }: { data: TemplateNodeData }) {
  return (
    <Card className="min-w-[180px] shadow-md border-teal-200 dark:border-teal-800 bg-teal-50/50 dark:bg-teal-900/20">
      <Handle type="target" position={Position.Left} className="w-3 h-3 bg-teal-500" />
      <CardHeader className="p-3 pb-1">
        <div className="flex justify-between items-center gap-2">
          <Badge variant="outline" className="text-[10px] px-1 py-0 h-4 border-teal-300 dark:border-teal-700">
