...
export const CrewInspector = ({ node, onNodeDataChange }: CrewInspectorProps) => {
    const [crewStatus, setCrewStatus] = useState(node.data.state || 'missing_context');

    const handleStatusChange = useCallback((newStatus: string) => {
        setCrewStatus(newStatus);
    ...
    return (
        <CardBody className="p-0 flex flex-col h-full bg-black">
            ...
            <ScrollShadow className="flex-1">
                ...
                {/* Simplified Working/Done states for monochromatic style */}
                {crewStatus === 'working' && (
                    <div className="p-6 space-y-6">
                        <div className="space-y-4">
