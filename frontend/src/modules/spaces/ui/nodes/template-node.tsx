        ...
        <>
            ...
            <Card className={`w-[280px] border-2 transition-all ${selected ? `${colorStyles.selected} !ring-2` : 'border-default-200'} !bg-white dark:!bg-[#0f0f0f]`}>
                ...
                <CardBody className="p-3 space-y-2">
                    <div className="flex justify-between items-center text-xs text-default-600 dark:text-default-400">
                        <span className="font-bold">Progress</span>
                        <span>{data.completedActions}/{data.totalActions} Done</span>
                    </div>
                    <Progress value={(data.completedActions / data.totalActions) * 100} color="default" size="sm" className="bg-default-100 dark:bg-default-800" />
                </CardBody>
            </Card>
