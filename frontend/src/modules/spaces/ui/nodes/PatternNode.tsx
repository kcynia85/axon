...
export const PatternNode = memo(({ data, selected }: NodeProps) => {
    ...
    return (
        <div className="select-none">
            ...
            <Card className={`w-[260px] border-2 transition-all ${selected ? `${colorStyles.selected} ${colorStyles.shadow} !ring-2` : 'border-zinc-700'} !bg-white dark:!bg-[#0f0f0f] shadow-sm`}>
