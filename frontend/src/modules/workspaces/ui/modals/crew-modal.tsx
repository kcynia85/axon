...
import { useAgents } from "@/modules/workspaces/application/use-agents";
import { useCreateCrew } from "@/modules/workspaces/application/use-crews";
import {
  Dialog,
  DialogContent,
  DialogDescription,
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select
                        ...
                        disabled={form.watch("crew_process_type") !== "Hierarchical"}
                      >
                        <FormControl>
                          <SelectTrigger className="text-xs">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-[10px] text-muted-foreground font-mono">
                    {form.watch("agent_member_ids")?.length || 0} units active
                  </span>
                </div>
            ...
            <DialogFooter className="p-4 border-t bg-muted/10">
              ...
              <Button
                ...
                disabled={form.watch("agent_member_ids")?.length < 1 || isPending}
              >
