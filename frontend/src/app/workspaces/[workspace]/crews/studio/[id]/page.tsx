...
import { EditCrewStudioContainer } from "@/modules/studio/features/crew-studio/ui/EditCrewStudioContainer";
...
export default async function EditCrewStudioPage({ params }: Props) {
