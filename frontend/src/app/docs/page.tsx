...
import { getBacklogContent, getChangelogContent, StructuredBacklog, MajorBacklogSection, BacklogItem } from "@/lib/docs-reader";
...
const DocsPage = async () => {
    ...
    return (
        <div className="container mx-auto py-10 px-4 h-full flex flex-col">
