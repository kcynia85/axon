      ...
      <div className="flex flex-wrap gap-2">
        {activeFilters.map((filter) => (
          <button
            ...
            className={cn(
              "group flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm font-bold transition-all border border-zinc-800",
              "bg-zinc-900 text-zinc-300 hover:text-white hover:border-zinc-700",
              "shadow-sm"
            )}
          >
            {filter.label}
